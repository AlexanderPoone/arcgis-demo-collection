...
class Toolbox(object):
    def __init__(self):
        self.label =  "HKPD Transformation"
        self.alias  = "HKPDTransformation"

        # List of tool classes associated with this toolbox
        self.tools = [HKPDTransformation] 

class HKPDTransformation(object):
    def __init__(self):
        self.label       = "HKPD Transformation"
        self.description = "Add Hong Kong Principal Datum (HKPD) Z values from Web API."
